...
public class DefaultCatalog extends CatalogImpl {
    ...
    /**
     * The schema <code>careercoachbooking</code>.
     */
    public final Careercoachbooking CAREERCOACHBOOKING = Careercoachbooking.CAREERCOACHBOOKING;
    ...
    public final List<Schema> getSchemas() {
        return Arrays.asList(
            Careercoachbooking.CAREERCOACHBOOKING
        );
    }
